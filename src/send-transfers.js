 ...
 * @param {number} transfers[].billDate - [Optional] The date the transfer should be executed on, formatted as a UNIX timestamp in seconds. Not specified or 0 indicates immediate processing.
